...
hi Folded		ctermfg=253		ctermbg=237		cterm=none		guifg=#a0a8b0	guibg=#3a4046	gui=none
...
hi DiffDelete	ctermfg=234		ctermbg=52		cterm=none		guifg=#1c1c1c	guibg=#d0d0d0	gui=none
hi DiffChange					ctermbg=234										guibg=#1c1c1c
hi DiffText						ctermbg=18										guibg=#000087
...
hi Todo			ctermfg=160		ctermbg=none	cterm=bold		guifg=#857b6f	gui=italic
